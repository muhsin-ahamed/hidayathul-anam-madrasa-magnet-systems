...
class _TeacherSettingsPageState extends State<TeacherSettingsPage> {
  ...
  Future<void> _pickCropAndUploadImage(ImageSource? source) async {
    ...
    try {
      ...
      final avatarUrl = await teacherRepo.uploadTeacherAvatar(
        teacher.profileId,
        uploadBytes,
        uploadFileName,
      );

      final updatedTeacher = teacher.copyWith(avatarUrl: avatarUrl);

      if (mounted) {
        TeacherShellScope.of(context)?.onTeacherUpdated(updatedTeacher);
      }
                ...
                ElevatedButton(
                  ...
                  onPressed: isSubmitting
                      ...
                      : () async {
                          ...
                          try {
                            final teacherRepo = context.read<TeacherRepository>();
                            final scope = TeacherShellScope.of(context);
                            final messenger = ScaffoldMessenger.of(context);

                            final updatedTeacher = await teacherRepo.updateTeacherProfile(
                              teacher.profileId,
                              fullName: newName,
                            ...
                            if (mounted) {
                              scope?.onTeacherUpdated(updatedTeacher);
                            }
  ...
  Widget build(BuildContext context) {
    ...
    final teacher = context.watch<Teacher>();
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Manage your faculty profile, appearance theme, security credentials, and account options.',
                  style: TextStyle(
                    fontSize: 15,
                              ...
                              children: [
                                CircleAvatar(
                                  ...
                                  child: _isUploadingAvatar
                                      ...
                                      : (teacher.avatarUrl == null || teacher.avatarUrl!.trim().isEmpty)
                                          ? Text(
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                if (teacher.username != null && teacher.username!.isNotEmpty)
                                  Text(
                                    '@${teacher.username}',
                                    style: TextStyle(
                                      fontSize: 14,
                                ...
                                Wrap(
                                  ...
                                  children: [
                                    Chip(
                                      ...
                                      label: Text(teacher.assignedClassName ?? 'No Class Assigned'),
                ...
                Container(
                  ...
                  child: ListTile(
                    ...
                    subtitle: const Text('Sign out of your teacher portal session'),
                    onTap: _handleLogout,
                  ),
                ),
